...
- [Что такое introspection?](answers.md/#Что-такое–интроспекция)
- [Как устроены переменные в Python](answers.md/#Как-устроены-переменные-в-Python)
- [Что означает термин разделяемые ссылки](answers.md/#Что-означает-термин-разделяемые-ссылки)
- [Что такое сборщик мусора в Python](answers.md/#Что-такое-сборщик-мусора)
- [Что такое циклические ссылки в контексте переменных в Python](answers.md/#Что-такое-циклические-ссылки-в-контексте-переменных-в-Python)
- [Отличие copy() от deepcopy()](answers.md/#Отличие-copy()-от-deepcopy())
- [Чем отличается is от ==](answers.md/#Чем-отличается-is-от-==)
- [Предельно допустимый размен переменной в Python](answers.md/#Предельно-допустимый-размен-переменной-в-Python)
- [Что такое переменная PYTHONPATH?](answers.md/#Что-такое-переменная-PYTHONPATH?)
- [Известные PEP](answers.md/#Известные-PEP)
...
- [Что делает оператор морж :=](answers.md/#Что-делает-оператор-морж-:=)
- [Чем отличается маг. метод __dict__ от функции dir()](answers.md/#Чем-отличается-маг.-метод-__dict__-от-функции-dir())
- [Что такое аннотации типов](answers.md/#Что-такое-аннотации-типов)
- [Что такое аннотация Union, Optinal](answers.md/#Что-такое-аннотация-Union,-Optinal)
- [Что такое виртуально окружение](answers.md/#Что-такое-виртуальное-окружение)
- [Что такое poetry, в чем преимущество перед pip](answers.md/#Что-такое-poetry,-в-чем-преимущество-перед-pip)
- [Что такое Python wheels](answers.md/#Что-такое-Python-wheels)
- [Что такое линтеры и форматеры(flake8, pylint, sonarlint, black)](answers.md/#Что-такое-линтеры-и-форматеры(flake8,-pylint,-sonarlint,-black))
- [Что такое mypy](answers.md/#Что-такое-mypy)

### Типы и встроенные структуры данных
- [Основные типы данных в Python](answers.md/#Основные-типы-данных-в-Python)
- [Какие типы данных относятся к встроенным структурам данных](answers.md/#Какие-типы-данных-относятся-к-встроенным-структурам-данных)
- [Для чего используется тип decimal. В каких случаях он лучше подходит чем float](answers.md/#Для-чего-используется-тип-decimal.-В-каких-случаях-он-лучше-подходит-чем-float)
- [Как можно перевести целое число в шестнадцатирично/восьмиричное/двоичное и обратно](answers.md/#Как-можно-перевести-целое-число-в-шестнадцатирично/восьмиричное/двоичное-и-обратно) 
- [Строки. Методы строк](answers.md/#Строки-Методы-строк)
- [Какие виды строк бывают в Python](answers.md/#Какие-виды-строк-бывают-в-Python)
- [Как кодировать и декодировать строки](answers.md/#Как-кодировать-и-декодировать-строки)
- [Списки. Методы списков. Как устроен под капотом](answers.md/#Списки.-Методы-списков.-Как-устроен-под-капотом)
- [Чем кортеж отличается от списка?](answers.md/#Чем-кортеж-отличается-от-списка?)
- [В каких случаях лучше использовать кортеж, а в каких - список?](answers.md/#В-каких-случаях-лучше-использовать-кортеж,-а-в-каких-список)
- [Что такое срез](answers.md/#что-такое-срез)
- [Кортежи. Методы кортежей](answers.md/#Кортежи.-Методы-кортежей)
- [Можно ли изменить список внутри кортежа](answers.md/#Можно-ли-изменить-список-внутри-кортежа)
- [Можно ли изменить кортеж внутри списка](answers.md/#Можно-ли-изменить-кортеж-внутри-списка)
...
- Что значит передача по ссылке / по значению
...
- Где Python ищет импортируемые модули
- Что такое пространство имен
- Можно ли осуществить динамическую загрузку модуля в Python прямо во время выполнения кода?
- Зачем может понадобиться использовать `__all__`
- В чем смысл использовать конструкцию `if __name__ == "__main__"`
